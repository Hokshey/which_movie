...
class PopbularList extends StatefulWidget {
  @override
  _MovieListState createState() => _MovieListState();
}

class _MovieListState extends State<PopbularList> {
  HttpHelper helper;
  String result;
  List movies;
  int moviesCount;
  ...
  Widget searchBar = Text('Popular Movies');
  @override
  void initState() {
              ...
              setState(() {
                if (this.visibleIcon.icon == Icons.search) {
                  ...
                  setState(() {
                    ...
                    this.searchBar = Text('Popular Movies');
                  });
                }
              });
            },
